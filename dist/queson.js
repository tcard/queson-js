...
peg$SyntaxError2.buildMessage = function(expected, found, location) {
  var DESCRIBE_EXPECTATION_FNS = {
    literal: function(expectation) {
      return '"' + literalEscape(expectation.text) + '"';
    },
...
function peg$parse2(input, options) {
  ...
  function peg$buildStructuredError(expected2, found, location2) {
    return new peg$SyntaxError2(peg$SyntaxError2.buildMessage(expected2, found, location2), expected2, found, location2);
  }
  function peg$buildError() {
    var expected2 = peg$expected[0];
    var failPos = expected2.pos;
...
function fromJSON(src) {
  return peg$parse2(src);
}
var QuesonSyntaxError = peg$SyntaxError;
var JsonSyntaxError = peg$SyntaxError2;
export {
  JsonSyntaxError,
  QuesonSyntaxError,
  fromJSON,
