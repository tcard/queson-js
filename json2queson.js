...
function peg$parse(input, options) {
  ...
  var peg$functions = [
    ...
    function(members) { return 'X.' + (members !== null ? members : '') + '.X'; },
    function(name, value) {
          return { name: name, value: value };
        },
    function(head, v) { return v; },
    function(head, tail) { return [head, ...tail].join('_'); },
    function(values) { return 'I.' + (values !== null ? values : '') + '.I'; },
    function(a, b, c, d) { return (a||'') + b + (c||'') + (d||''); },
    function(s, i) { return 'e' + (s||'') + i.join(''); },
    function() { return text(); },
    function() { return ''; },
    function(chars) { return "w." + chars.join("") + ".w"; },
    function() { return ".."; },
    function() { return "._"; },
    function() { return "_"; },
    function() { return '"'; },
